    ...
    <div class="flex items-start gap-3">
        ...
        <div class="w-full min-w-0 grid gap-1">
            ...
            <div class="relative mt-1">
                ...
                >
                    @if($task->memo)
                        <p class="text-sm text-gray-600 bg-gray-50 p-2 rounded hover:bg-gray-100 transition-colors {{ $task->completed_at ? 'opacity-50' : '' }}">
                            {!! nl2br(e($task->memo)) !!}
                        </p>
                    @else
                        <div class="text-xs text-gray-400 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity p-1">
